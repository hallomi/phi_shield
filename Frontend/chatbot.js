...
// ─────────────────────────────────────────────
function formatPatientResponse(rawText) {
    ...
    if (rawText.includes("Patient") && (rawText.includes("BP") || rawText.includes("HR"))) {
        ...
        if (hrMatch)
            formatted += `• Heart Rate: ${hrMatch[1]} bpm\n`;
...
// ─────────────────────────────────────────────
function addChatBubble(sender, text, isFormatted = false) {
...
// 7. INITIAL MESSAGE
// ─────────────────────────────────────────────
addChatBubble("bot", "Hello! I'm your clinical assistant. How can I help you today?");
...
// ─────────────────────────────────────────────
chatForm.addEventListener("submit", (event) => __awaiter(void 0, void 0, void 0, function* () {
