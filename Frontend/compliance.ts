...
function initializeCharts() {
  ...
  const phiAccessOverTimeCanvas = document.getElementById("phiAccessOverTimeChart") as HTMLCanvasElement;
  ...
  const phiAccessByUserCanvas = document.getElementById("phiAccessByUserChart") as HTMLCanvasElement;
  if (phiAccessByUserCanvas) {
    ...
    if (ctx2) {
      ...
      const timestamps = [];
      const userAccessData: { [key: string]: number[] } = {};
